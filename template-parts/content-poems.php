<div class="container mb-5 banner">
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-6 text-center">
            <?php
            $poems_image = get_field('poems_image');
            if( !empty( $poems_image ) ): ?>
                <img class="img-fluid" src="<?php echo esc_url($poems_image['url']); ?>" alt="<?php echo esc_attr($poems_image['alt']); ?>" width="400" />
            <?php endif; ?>
        </div>
